...
class BottomNavBarWidget extends StatelessWidget {
  ...
  final VoidCallback onTapLinSkipper;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _BottomNavBarItem(
            icon: LineItUpIcons().lineskipper,
            isSelected: 2 == currentIndex,
            label: translate(context, 'line_skipper'),
            onTap: onTapLinSkipper,
          ),
          _BottomNavBarItem(
